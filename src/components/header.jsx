...
const Header = () => {
    ...
    const handleHelpButtonClick = e => {
        e.preventDefault();
        Swal.fire('Do you need help?', 'You can contact us 24/7.', 'question');
    }
                                ...
                                <Nav>
                                    {user.email ? (
                                        <>
                                            ...
                                            <Button variant="danger" className="py-0 ms-2" onClick={handleLogout}>
                                                Log out
                                            </Button>
                                        </>
                                    ) : (
                                    ...
                                    {/* ✅ Always Show Payment Link */}
                                    <Nav.Link as={Link} to="/payment" eventKey="i">
                                        Payment 💳
                                    </Nav.Link>
                                ...
                                <Row>
                                    <Col xs={12} md={4}>
                                        <span className="fs-6">
                                            ...
                                            <a href="https://maps.app.goo.gl/L5oUJYr6ZYUMYZVn9" target="_blank" rel="noopener noreferrer" className="text-white">
                                                DriveOn Rentals – Bhubaneswar
                                            </a>
                                        </span>
                                    </Col>
                                    <Col xs={12} md={4}>
                                        <span className="fs-6">
                                            ...
                                            <a href="tel:+919999999999" className="text-white">+91 99999 99999</a>
                                        </span>
                                    </Col>
                                    <Col xs={12} md={4}>
                                        <span className="fs-6">
                                            <GrMail className="header-line-2-icon" />&nbsp;
                                            <a href="mailto:adityaraul408@gmail.com" className="text-white">adityaraul408@gmail.com</a>
                                        </span>
                                    </Col>
                                </Row>
                            </Col>
